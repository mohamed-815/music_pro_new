...
import 'package:music_pro_1/presentation/detailsongs/detailcontroller.dart';
...
import 'package:music_pro_1/presentation/playlist/widgets/showbottomsheetplaylist.dart';
                        ...
                        ListTile(
                          ...
                          trailing: GestureDetector(
                            onTap: () {
                              showBottomSheet(
                                  backgroundColor:
                                      const Color.fromARGB(255, 53, 78, 71),
                        ...
                        Container(
                          child: Row(
                            ...
                            children: [
                              ...
                              detailcontroller.faveCheck(nowplayingsongfavorite)
                                  ? IconButton(
                                      onPressed: () async {
                                        detailcontroller
                                            .addToFavoriteFromDetail(
                                                nowplayingsongfavorite);
                                        // favoriteController.favoritesongs
                                        //     .add(nowplayingsongfavorite);
                                        // await favoritebox.put(
                                        //     'favorite', favoriteController.favoritesongs);
                                        // setState(() {
                                        //   favoriteController.favoritesongs =
                                  ...
                                  : IconButton(
                                      onPressed: () async {
                                        detailcontroller
                                            .removeFav(nowplayingsongfavorite);
                              ...
                              GestureDetector(
                                  onTap: () async {
                                    await detailcontroller.loopMode();
                                    // setState(() {
                                    //   if (counting % 2 == 0) {
                                  ...
                                  child: detailcontroller.counting % 2 == 0
                                      ? Icon(
                                          Icons.repeat,
                                          color: Colors.grey.shade200,
                                        )
                        ...
                        Row(
                          ...
                          children: [
                            GestureDetector(
                              ...
                              onTap: () async {
                                detailcontroller.addToRecentcurentsongdetail(
                                    curentsongdetail);
